...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_replayCallout_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_replayCallout_t qt_meta_stringdata_replayCallout = {
    {
QT_MOC_LITERAL(0, 0, 13), // "replayCallout"
QT_MOC_LITERAL(1, 14, 14), // "ShowHideDialog"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "replayCallout\0ShowHideDialog\0"
};
...
void replayCallout::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        replayCallout *_t = static_cast<replayCallout *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject replayCallout::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_replayCallout.data,
      qt_meta_data_replayCallout,  qt_static_metacall, nullptr, nullptr}
};
...
void *replayCallout::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_replayCallout.stringdata0))
        return static_cast<void*>(const_cast< replayCallout*>(this));
